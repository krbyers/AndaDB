...
SELECT 
	  ...
	  ,CAST(           sb2.C2SHWS                                AS VARCHAR(2))    AS first_warehouse
	  ,CAST(           sb2.C2SHW2                                AS VARCHAR(2))    AS second_warehouse
	  ,CAST(           sb2.C2SHW3                                AS VARCHAR(2))    AS third_warehouse
